...
def color_fulness_features(image_rgb):
    """ based on serges project,
        refering to http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.14.4913&rep=rep1&type=pdf
    """
...
def ceiq(image, gray=False):
    """ python version of https://github.com/mtobeiyf/CEIQ/blob/master/CEIQ.m
